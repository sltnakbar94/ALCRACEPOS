    ...
    $(document).ready( function () {
        ...
        $('#table').DataTable({
          ...
          columns: [
                ...
                { data: 'quantity', name: 'itemSum.aggregate',"orderable": false, "searchable": false },
...
<div class="slim-mainpanel">
  <div class="container-fluid">
    <div class="slim-pageheader">
      ...
      <h6 class="slim-pagetitle">Transaksi Penjualan Tiket @if(request('from') == request('to')) - Hari Ini @endif</h6>
    </div><!-- slim-pageheader -->
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="col-sm-12" style="margin-top: 29px;">
                        ...
                        <a href="{{ route('transTicketView') }}" class="btn btn-danger mg-b-10" id="addButton"><i class="fa fa-close mg-r-5"></i> Bersihkan Filter</a>
                    </div>
                </div>
            </div>
            {{ Form::close() }}
