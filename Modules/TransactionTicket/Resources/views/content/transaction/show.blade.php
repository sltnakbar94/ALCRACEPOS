        ...
        <div class="col-md-12">
          ...
          <div class="form-row">
            ...
            <span class="col-md">: {{ $transaction->transaction_number }}
              <a href="{{ route('transTicketDetail',['receipt'=>'true','number' => $transaction->transaction_number]) }}" class="btn btn-sm btn-secondary float-right"><i class="fa fa-print fa-fw"></i> Print Transaksi</a>
            </span>
          </div>
          <div class="form-row">
        ...
        <div class="col-md-12">
          <table class="table display nowrap" width="100%" id="table">
            ...
            <tbody>
                ...
                <td>
                  @if ($transaction->cashback == false)
                    @if (Auth::user()->hasRole('staff'))
                      <a href="{{ route('refundTicketView',['transNum' => $transaction->transaction_number,'item' => $item->id]) }}" class="btn btn-danger btn-sm"><i class="fa fa-mail-forward fa-fw"></i> Refund</a>
                    @else
              ...
              @endforeach
              <tr>
                <td align='center' colspan='4'><span class="font-weight-bold">SUBTOTAL</span></td>
                <td colspan='2'>{{ number_format($beforeCashback) }}</td>
              </tr>
              <tr>
                <td align='center' colspan='4'><span class="font-weight-bold">CASHBACK</span></td>
                <td colspan='2'>{{ '-'.number_format($transaction->cashback) }}</td>
              </tr>
              <tr>
