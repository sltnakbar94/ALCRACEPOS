...
<div class="slim-header">
  <div class="container">
    <div class="slim-header-left">
      <h2 class="slim-logo"><a href="{{ url('/') }}">ALC <small>Super Admin <span class="cabang"> - (Cabang Kutabumi , Tanggerang)</span></small></a></h2>
  ...
  <div class="container">
    <ul class="nav">
      ...
      <li class="nav-item with-sub">
        ...
        <div class="sub-item">
          <ul>
            <li><a href="{{ route('transItemView',['staff'=>'','from' => date('d-m-Y'),'to' => date('d-m-Y')]) }}">Laporan Transaksi Corner</a></li>
            ...
            <li class="sub-with-sub">
              ...
              <ul>
                {{-- <li><a href="">Laporan Perhari</a></li> --}}
            ...
            <li class="sub-with-sub">
              ...
              <ul>
                <li><a href="{{ route('reportBestSellingWahana') }}">Wahana</a></li>
                <li><a href="{{ route('reportBestSellingItem') }}">Item</a></li>
              </ul>
            </li>
            <li><a href="{{ route('opTaxReport') }}">Laporan Pajak</a></li>
          </ul>
        </div><!-- sub-item -->
      </li>
      <li class="nav-item with-sub">
        ...
        <div class="sub-item">
          <ul>
            ...
            <li><a href="{{ route('approvalWhView') }}">Permintaan Perubahan Harga</a></li>
          </ul>
        </div><!-- dropdown-menu -->
      </li>
      {{-- <li class="nav-item with-sub">
        ...
        <div class="sub-item">
          <ul>
            ...
            <li><a href="{{ route('approvalItemView') }}">Permintaan Perubahan Harga</a></li>
          </ul>
        </div><!-- dropdown-menu -->
      </li> --}}
      <li class="nav-item">
      ...
      <li class="nav-item with-sub">
        ...
        <div class="sub-item">
          <ul>
            <li><a href="{{ route('opTax') }}">Pengaturan Pajak</a></li>
          </ul>
        </div><!-- dropdown-menu -->
      </li>
    </ul>
