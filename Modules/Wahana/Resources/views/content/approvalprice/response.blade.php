...
<div class="slim-mainpanel">
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card card-body">
          <a href="{{ route('approvalWhStoreGet',['id' => $item->id,'status'=>'Approved']) }}" class="btn btn-block btn-success"><i class="fa fa-check fa-fw"></i> Setuju Melakukan Perbuahan Harga</a>
          <br>
...
<div id="myModal{{ 'not' }}" class="modal fade">
  <div class="modal-dialog modal-lg" style="width:30%" role="document">
        <div class="modal-content tx-size-sm">
          ...
          {{ Form::open(['route' => 'approvalWhStorePost','autocomplete' => 'off']) }}
