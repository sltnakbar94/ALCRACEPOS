...
<div class="slim-mainpanel">
  <div class="container-fluid">
    <div class="slim-pageheader">
      ...
      <h6 class="slim-pagetitle">Laporan Rincian Shift</h6>
    </div><!-- slim-pageheader -->
    @role(['storemanager','superadministrator'])
            ...
            @if (request()->has(['from']))
                <div class="alert alert-info">
                    ...
                    Berikut Laporan Per Tanggal <span class="font-weight-bold">@if (request()->has(['from','to']))({{ date('d-m-Y',strtotime(request('from'))) }} s/d {{ date('d-m-Y',strtotime(request('to'))) }})@endif </span>
                </div>
            @endif
        @endrole
